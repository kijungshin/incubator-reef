...
public final class OutputServiceTask implements Task {
  ...
  /**
   * Output stream provider object thorough which tasks create output streams.
   */
   ...
   *
   * @param outputStreamProvider Output stream provider object thorough which tasks create output streams.
   */
  @Inject
